...
void define_static_objects(void) {
	...
	static_objects[OBJ_LIGHT].pos[5] = glm::vec3(166.0f, 153.0f, 49.0f);
	...
	static_objects[OBJ_TEAPOT].ModelMatrix[1] = glm::translate(glm::mat4(1.0f), glm::vec3(193.0f, 120.0f, 50.0f));
