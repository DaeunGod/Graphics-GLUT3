...
void set_up_scene_lights(void) {
	...
	light[6].light_on = 1; 
	light[6].position[0] = 166.0f; light[6].position[1] = 153.0f; // spot light position in WC
	...
	//glm::vec3 direction_EC = glm::mat3(ViewMatrix[0]) * glm::vec3(light[1].spot_direction[0], light[1].spot_direction[1],
